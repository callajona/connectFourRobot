...
int main(int argc, char** argv) {
  ...
  std::ofstream MyFile;
  MyFile.open("/home/project/projects/Solver_Pascal/LUT/LUT_3.txt",std::ios::app); // std::ios::app - non destrictive writing [app = append mode]
  ...
  std::cout << "Matching move: " << matching_move_count << std::endl;
  std::cout << "Flipped move: " << flipped_move_count << std::endl;
  ...
  */
  ...
  // Create and open a text file
  std::ofstream MyFile;
  MyFile.open("/home/project/projects/Solver_Pascal/LUT/LUT_5_2.txt"); // std::ios::app - non destrictive writing [app = append mode]
        ...
        for (int i_4 = 0; i_4 < 7; i_4++) {
          for (int i_5 = 0; i_5 < 7; i_5++) {
            ...
            if (int_move > 11414) {
              ...
              if (matching_Flipped_move != "X" && matching_move != "X") {
                symbol = "B";
                both_count++;
              }
              else if (matching_move != "X") {
                symbol = "M";
                match_count++;
              }
              else if (matching_Flipped_move != "X") {
              ...
              */
              ...
              MyFile << colScores[6] << "] " << symbol << std::endl; 
            }
          }
        }
      }
  ...
  std::cout << "Both: " << both_count << std::endl;
  std::cout << "Match: " << match_count << std::endl;
  std::cout << "Flipped: " << flip_cout << std::endl;
}
